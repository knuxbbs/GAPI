...
{
    /// <summary>
    /// Generation statistics class implementation
    /// </summary>
    public class Statistics
    {
        ...
        public static void Report()
        {
            ...
            Console.WriteLine("Total Nodes: " + (enums + structs + boxed + opaques + interfaces + cbs + objects +
                                                 props + sigs + methods + ctors + throttled));
            Console.WriteLine();
        }
    }
}